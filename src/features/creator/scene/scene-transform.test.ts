...
describe("scene transforms", () => {
  ...
  it("places a physical obstacle on the center of its domain footprint", () => {
    const box = obstacleToScene({ id: "obstacle_box", kind: "obstacle", name: "Box", position: { xCm: 50, zCm: 60 }, dimensions: { widthCm: 100, depthCm: 40, heightCm: 200 }, functionalClearance: { frontCm: 0, backCm: 0, leftCm: 0, rightCm: 0 }, rotation: 90, locked: false }, room);
