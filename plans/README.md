...
| 4 | [Phase 20 — 3D room preview completion](phase-20-3d-preview.md) | Phases 15–17, 19 | The scene integrates placement state, selection sync with the 2D plan, validation presentation, and representative complete-room performance, without becoming the editing or validation source of truth. Narrow this to selection and validation if time is short; asset breadth belongs to Phase 16. |
